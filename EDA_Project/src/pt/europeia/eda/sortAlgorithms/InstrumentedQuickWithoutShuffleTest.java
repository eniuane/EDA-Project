...
public class InstrumentedQuickWithoutShuffleTest {
	...
	public static void execute(final int limit, final String filesToTest) {
		...
		InstrumentedQuickWithoutShuffle.sort(numbersToSortSorted);
	...
	public static void performExperimentsFor(final int limit, final String filesToTest) {
		...
		out.println("Sorted " + limit + "\t Accesses= " + InstrumentedQuickWithoutShuffle.getNumberOfArrayAccesses()
				+ "\t Reads= " + InstrumentedQuickWithoutShuffle.getNumberOfArrayReads() + "\t Writes= "
				+ InstrumentedQuickWithoutShuffle.getNumberOfArrayWrites() + "\t Compares= "
				+ InstrumentedQuickWithoutShuffle.getNumberOfComparisons() + "\t Swaps= "
				+ InstrumentedQuickWithoutShuffle.getNumberOfSwaps());
	}
